...
import { 
  ...
  Lock, Eye, EyeOff, Save, CheckCircle, AlertCircle, X
} from 'lucide-react';
import { getProfile, updateProfile, changePassword } from '../../services/patientService';
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`w-full px-4 py-3 rounded-xl border text-sm outline-none pr-11 ${
                        passwordErrors.current_password ? 'border-red-300 bg-red-50' : 'border-gray-200 focus:border-blue-400'
                      }`}
                      required
                    />
                    <button
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <textarea
                    ...
                    rows={2}
                    className="w-full pl-10 pr-4 py-3 rounded-xl border border-gray-200 text-sm outline-none focus:border-blue-400 resize-none"
                  />
                </div>
              </div>
            ...
            <div className="p-5">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400">View appointments, medical records, and billing</p>
                </div>
              </div>
            </div>
          </div>
